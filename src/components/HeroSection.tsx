  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ paddingTop: '0px', paddingBottom: '32px' }}
      ...
      >
        ...
        <motion.p
          ...
          style={{ fontSize: 'clamp(26px, 8vw, 40px)', marginBottom: '-2px' }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          ...
          style={{ fontSize: 'clamp(13px, 4vw, 18px)', marginBottom: '8px' }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <h1
            ...
            style={{ fontSize: 'clamp(34px, 10vw, 60px)' }}
          >
            Karim & Nada
          </h1>
          ...
          <p
            ...
            style={{ fontSize: 'clamp(22px, 6.6vw, 34px)', marginTop: '-4px' }}
            dir="rtl"
          >
